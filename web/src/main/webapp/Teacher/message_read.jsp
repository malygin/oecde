...
<jsp:useBean id="messg" class="msgs.model.Messg"/>
 ...
 <jsp:setProperty name="messg" property="user"  value="${sessionScope[\"teacherItem\"]}"/>
                ...
                <tr>
                  ...
                  <c:choose>
                        <c:when test="${message.studentSender ne null}">
                           ...
                           (<a class="load_added_file" href="#dialog_msg/id=${message.studentSender.id}&type=4">Диалог</a>)
                        </c:when>
                        <c:when test="${message.teacherSender ne null}">
                         ...
                         (<a class="load_added_file" href="#dialog_msg/id=${message.teacherSender.id}&type=3">Диалог</a>)
                        </c:when>
                         <c:when test="${message.adminSender ne null}">
                          ...
                          (<a class="load_added_file" href="#dialog_msg/id=${message.adminSender.id}&type=1">Диалог</a>)
                        </c:when>
                        <c:otherwise>
    ...
    <div class="new_letter_body">
        ...
        <div class="reply_area"><p class="fast_answer">Быстрый ответ |
           <c:choose>
            ...
            <textarea id="text_<c:out  value="${message.id}"/>" dojoType="dijit.form.Textarea" style="width: 480px; height: 150px; max-height: 150px;">(Ваше сообщение здесь)
