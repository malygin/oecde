...
<script type="text/javascript">
    ...
    var t = setTimeout(function tm1234(){
        dojo.xhrPost({
            content:{id: id},
            url: "UmkReadingLoggingServlet.c"
        })
        clearTimeout(t);
    },120000)
</script>
...
<body style="padding: 0px; margin: 0px; //overflow-y: hidden;">
	...
	<div class="pages">
		<div class="smeshenie_pages">
			...
			<div class="pages_block">
				<p><a class="page_link" href="" id="last">К курсу</a></p>
			</div>
			<div class="pages_block">
					...
					<div style="position: relative; left: -46px;" id="toolbarPane">
						<div class="toolbar">
							...
							<div id="tools" class="tools">
                                ...
                                <input type="image" src="../images/pic.jpg" name="button" onclick="defolt_text('infopart')">
