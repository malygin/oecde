...
<link href="../style/studentStyles.css" rel="stylesheet" type="text/css">
 ...
 <c:set target="${test.testI}"  property="id"  value="${id}"/>
...
<div class=title>
    ...
    <c:if test="${testI eq null}">
     <c:set var="isValid" value="false" scope="session"/>
       <div id=head>
...
<div align="center"  id="testBody" dojoType="dijit.Dialog" open="false" title="Тестирование" style="width: 90%" href="" refreshOnShow>
    ...
    <div id=answ align="left" style="display:inline" height="300" >
        <form  id="answersForm" name="answersForm" dojoType="dijit.form.Form">$$ \int {2\over x}\,dx = \ln(x)+C $$</form>
