            ...
            <tr>
                <td>
                    ...
                    <div style="text-align: center; padding-bottom: 10px;">
                        <p align="center"><a class='send_mes_link_st_page'  href='anotherType.do?type=student&id=${studentI.id}' >Зайти под студентом</a></p>
                        ...
                        <p align="center"><a class='send_mes_link_st_page' href="javascript:deletePhoto(<c:out value="${studentI.id},'student')"/>">Удалить фото</a></p>
