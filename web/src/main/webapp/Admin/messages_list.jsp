...
<%
    ...
    AdminItem student=(AdminItem)session.getAttribute("adminItem");
             ...
             <tr>
                <td  style="width: 300px;">
                  <c:if test="${messg.typeList eq 'in'}">
                                     <c:choose>
                                        <c:when test="${message.studentSender ne null}">
                                            <div class="text_whoom_mes" style="color: #00BDFF;">сообщение от студента</div>
                                        </c:when>
                                        <c:when test="${message.teacherSender ne null}">
                                            <div class="text_whoom_mes" style="color: green;">сообщение от преподавателя</div>
                                        </c:when>
                                         <c:when test="${message.adminSender ne null}">
                                             <div class="text_whoom_mes" style="color: red;">сообщение от администратора</div>
                                        </c:when>
                                        <c:otherwise>
