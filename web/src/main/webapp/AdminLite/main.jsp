                    ...
                    <div class="l_t_angle">
                        <div class="r_t_angle">
                            <div class="r_b_angle">
                                <div class="l_b_angle">
                                    <div class="inf_pole">
                                        <%@include file="../WEB-INF/AdminLite/jspf/l_menu.jspf" %>
                                        <div class="right">
                                             <%@include file="../WEB-INF/AdminLite/jspf/t_menu.jspf" %>
                                            <div class="right_inside">
                                                <div>
                                                    <div class="inf">
                                                         <%@include file="../WEB-INF/AdminLite/jspf/fio.jspf" %>
...
loadingMessage='<div align="center" id="loader" style="z-index: 100; position: relative; margin-top:110px;"><img src="../images/loader1.gif"></div>'>
                                                     ...
                                                     <%@include file="../WEB-INF/AdminLite/jspf/r_menu.jspf" %>
                                    ...
                                    <%@include file="../WEB-INF/AdminLite/jspf/b_menu.jspf" %>
                                </div>
                            </div>
                        </div>
                    </div>
