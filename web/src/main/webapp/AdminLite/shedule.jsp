...
<script type="text/javascript">
        ...
        document.title="СГУ ЦОО. Расписание"
</script>
...
<div class=list style="margin-top:10px">
    <ol>
        ...
        <li class="first_back_${n.index%2+1}_stteachers">
            <div align="center">
                <a  class="teh_a" href="../files_sessia/${year}/<c:out value="${sessionScope.liteAdminItem.city.engName}"/>${year}${sp.key.shortName}.xls">${sp.key.name}, ${year}курс</a>
