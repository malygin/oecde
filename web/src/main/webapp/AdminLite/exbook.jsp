...
<body style="padding: 0px; margin: 0px; //overflow-y: hidden;">
	...
	<div class="pages">
		<div class="smeshenie_pages">
			...
			<div class="pages_block">
                <a class="page_link" id="back" href=""><img  src="../umkImages/book.jpg"></a>
			</div>
			<div class="pages_block">
                <p></p>
			</div>
			<div class="author" id="moduleName">
			</div>
		</div>
	</div>
</div>
...
<div align="center" id="move_block" class="move_block">
	<div class="info_block" >
					<div style="position: relative; left: -46px;" id="toolbarPane">
						<div class="toolbar">
							<div class="panel_open" id="green" onclick="sh_hi_bar(2, 'red', this);">
								<input type="image" src="../umkImages/open_panel2.png" name="button">
							</div>
							<div class="panel_close" id="red" onclick="sh_hi_bar(1, 'green', this);">
								<input type="image" src="../umkImages/close_panel.png" name="button">
							</div>
							<div id="tools" class="tools">
								<input type="image" src="../umkImages/plus.png" name="button" onclick="text_size('infopart')">
								<input type="image" src="../umkImages/minus.png" name="button" onclick="text_size_min('infopart')">
								<input type="image"src="../umkImages/question.png" name="button">
								<input type="image" src="../umkImages/tools.png" name="button">
							</div>
						</div>
					</div>
            ...
            class="info" style="font-size: 10pt; margin-top: 80px;">
				</div>
		</div>
	</div>
</div>
