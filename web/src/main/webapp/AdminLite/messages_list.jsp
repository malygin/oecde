...
<%
    ...
    AdminItem student=(AdminItem)session.getAttribute("liteAdminItem");
           ...
           <tr>
                <td colspan="2" id="theme_of_letter_<c:out value="${message.id}"/>">
                   <c:if test="${messg.typeList ne 'out'}">
                    ...
                    <c:if test="${messg.typeList eq 'out'}">
                      <p class="theme_of_res_letter">  <c:out value="${message.them}"/></p>
                  </c:if>
               </td>
            ...
            <tr>
                <td colspan="2" style="padding-top: 2px; padding-bottom: 2px;">
                  ...
                  <c:if test="${messg.typeList ne 'out'}">
                   ...
                   <c:if test="${messg.typeList eq 'out'}">
                               <p class="text_of_letter_from_list"><c:out value="${message.short_text}" escapeXml="false" /></p>
                    </c:if>
