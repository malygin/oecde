...
/**
 * <p>Java class for roleMetaVocab complex type.
 * <p/>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p/>
 * <pre>
 * &lt;complexType name="roleMetaVocab">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice maxOccurs="unbounded" minOccurs="0">
 *         &lt;element name="source" type="{http://ltsc.ieee.org/xsd/LOM}sourceValue"/>
 *         &lt;element name="value" type="{http://ltsc.ieee.org/xsd/LOM}roleMetaValue"/>
...
@XmlType(name = "roleMetaVocab", propOrder = {
        "sourceOrValueOr"
})
@XmlSeeAlso({
        RoleMeta.class
})
public class RoleMetaVocab {

    @XmlElements({
            @XmlElement(name = "source", type = SourceValue.class),
            @XmlElement(name = "value", type = RoleMetaValue.class)
    })
